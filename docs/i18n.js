...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      "mac.dl.note": "应用未公证（公证需要付费的 Apple Developer ID），因此首次打开需要一次右键放行，之后即可正常使用。",
      "mac.getting": "获取 / 构建",
      ...
      "mac.require": "系统要求",
      "mac.req": "系统要求：macOS 13.0+（Ventura）。首次使用需在「系统设置 → 隐私与安全性 → 屏幕录制」中授予权限。",
      "mac.privacy": "隐私",
    ...
    en: {
      ...
      "mac.dl.1": "Unzip and drag MagicMirror.app into the Applications folder.",
      "mac.dl.2": "First launch: right-click the app → <strong>Open</strong> → Open.",
      "mac.dl.3": "Grant permission in System Settings → Privacy & Security → Screen Recording, then relaunch.",
      "mac.dl.note": "The app is not notarized (that requires a paid Apple Developer ID), so the first launch needs a one-time right-click Open.",
      "mac.getting": "Get it",
      ...
      "mac.req": "Requirements: macOS 13.0+ (Ventura). Grant screen recording permission in System Settings → Privacy & Security when first asked.",
      "mac.privacy": "Privacy",
